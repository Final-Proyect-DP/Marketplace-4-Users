...
.then(() => {
  ...
  // Inicializar consumidores después de conectar MongoDB
...
// Función para inicializar los consumidores
function initializeKafkaConsumers() {
  // Inicializar userCreated consumer
  userCreated.consumer.connect();
  
  // Inicializar userDelete consumer
  userDelete.consumer.connect();
  
  // Inicializar userEdit consumer
  userEdit.consumer.connect();
}
